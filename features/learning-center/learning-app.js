(function () {
  ...
  function profile() { return '<div class="lc-demo"><span>本地 Mock · V1.1</span><label>预览身份 <select data-profile>' + D.state().users.map(function (u) { return '<option value="' + u.id + '"' + (u.id === D.user().id ? ' selected' : '') + '>' + e(u.name) + ' / ' + ({ super: '超级管理员', learner: '学员', course: '课程管理员', study: '学情管理员' }[u.roles[0]]) + '</option>'; }).join('') + '</select></label></div>'; }
  ...
  function syncBreadcrumb() {
    ...
    if (host && (view === 'manage' || view === 'stats')) controller.setDetail('learning', view === 'manage' ? '课程管理' : '学情管理', function () { setView('list'); });
  ...
  function render() {
    ...
    if (view === 'list') renderList(); else if (view === 'detail') renderDetail(); else if (view === 'player') renderPlayer(); else if (view === 'manage') renderManage(); else if (view === 'edit') renderEditor(); else if (view === 'stats') renderStats();
    host.dataset.learningView = view;
    syncBreadcrumb();
  }
  function renderList() {
    host.innerHTML = '<div class="gaip-course-list-view">' + listHeader + profile() + '<div class="gaip-learning-scroll"><div class="gaip-learning-grid">' + D.availableCourses().map(function (c) {
  ...
  function openLearningLog(study) {
    if (!D.admin(study?'study':'course')) return toast(study?'没有学情管理权限':'没有课程管理权限');
    ...
    logTable = window.__GAIP_TABLE__.mount(dialog.querySelector('.lc-course-log-table'), {
      title: study?'学情操作日志':'课程操作日志', rows: study?studyLogs:D.courseLogs(), minWidth: 1120, rowVerticalAlign: 'top', boundary: dialog.querySelector('.lc-course-log-body'), bottomGap: 0,
  ...
  function bind(el) {
    el.addEventListener('click',function(ev){var management=ev.target.closest('[data-learning-action]');if(management){var next=management.dataset.learningAction==='课程管理'?'manage':'stats';return setView(next);}var b=ev.target.closest('[data-lc]');if(!b||b.disabled)return;attempt(function(){action(b.dataset.lc,b.dataset.id);});});
    ...
    el.addEventListener('change',function(ev){var t=ev.target;
      ...
      if(t.matches('[data-profile]')){D.setUser(t.value);return setView('list');}
  ...
  window.__GAIP_LEARNING_APP__={
    mount:function(el){host=el;listHeader=el.querySelector('.gaip-learning-header').outerHTML;view='list';host.classList.add('gaip-learning-v11');bind(el);render();var previewId=new URLSearchParams(window.location.hash.split('?')[1]||'').get('gaip-preview');if(previewId){var c=D.course(previewId);if(D.admin('course')&&c&&c.status==='draft')openCourse(previewId);else toast('草稿不存在、已变更状态或当前身份无预览权限');}},
    destroy:function(){clearUploads();pruneLocalFiles(true);clearEditorFeedback();stop(); finishLessonDrag(false);if(editorGroups){editorGroups.destroy();editorGroups=null;}if(filterBar){filterBar.destroy();filterBar=null;}if(manageTable){manageTable.destroy();manageTable=null;}D.closeAccess(courseAccess);courseAccess=null;document.querySelectorAll('[data-learning-dialog]').forEach(function(d){d.close();});host=null;session=null;syncBreadcrumb();},
  ...
  /* @gaip-modal
  {"id":"learning-course-log","title":"课程管理操作日志","channel":"学习中心","type":"modal","category":"information","status":"ready","source":"window.__GAIP_LEARNING_APP__.openCourseLog()","invoke":{"path":"__GAIP_LEARNING_APP__.openCourseLog","args":[]},"styles":["shared/styles/global-modal.css","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1","shared/styles/global-filter-bar.css?v=20260910-tree-combobox-1","shared/styles/global-table.css","features/learning-center/learning-v11.css?v=20260910-study-detail-modal-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/global-filter-bar.js?v=20260910-tree-combobox-1","shared/scripts/global-table.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"]}
  */
  /* @gaip-modal
  {"id":"learning-operation-confirm","title":"课程上架确认","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","source":"window.__GAIP_LEARNING_APP__.openConfirm(\"course-publish\")","invoke":{"path":"__GAIP_LEARNING_APP__.openConfirm","args":["course-publish"]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"]}
  */
  /* @gaip-modal
  {"id":"learning-unsaved-confirm","title":"学习中心未保存离开确认","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","after":"learning-operation-confirm","source":"window.__GAIP_LEARNING_APP__.openUnsaved()","invoke":{"path":"__GAIP_LEARNING_APP__.openUnsaved","args":[]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"]}
  */
  /* @gaip-modal
  {"id":"learning-course-offline-confirm","title":"课程下架确认","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","source":"window.__GAIP_LEARNING_APP__.openConfirm(\"course-offline\")","invoke":{"path":"__GAIP_LEARNING_APP__.openConfirm","args":["course-offline"]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"after":"learning-unsaved-confirm"}
  */
  /* @gaip-modal
  {"id":"learning-course-delete-confirm","title":"删除草稿课程确认","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","source":"window.__GAIP_LEARNING_APP__.openConfirm(\"course-delete\")","invoke":{"path":"__GAIP_LEARNING_APP__.openConfirm","args":["course-delete"]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"after":"learning-course-offline-confirm"}
  */
  /* @gaip-modal
  {"id":"learning-lesson-publish-confirm","title":"课节上架确认","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","source":"window.__GAIP_LEARNING_APP__.openConfirm(\"lesson-publish\")","invoke":{"path":"__GAIP_LEARNING_APP__.openConfirm","args":["lesson-publish"]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"after":"learning-course-delete-confirm"}
  */
  /* @gaip-modal
  {"id":"learning-lesson-offline-confirm","title":"课节下架确认","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","source":"window.__GAIP_LEARNING_APP__.openConfirm(\"lesson-offline\")","invoke":{"path":"__GAIP_LEARNING_APP__.openConfirm","args":["lesson-offline"]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"after":"learning-lesson-publish-confirm"}
  */
  /* @gaip-modal
  {"id":"learning-last-lesson-offline-confirm","title":"最后课节下架限制提示","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","source":"window.__GAIP_LEARNING_APP__.openConfirm(\"last-lesson-offline\")","invoke":{"path":"__GAIP_LEARNING_APP__.openConfirm","args":["last-lesson-offline"]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"after":"learning-lesson-offline-confirm"}
  */
  /* @gaip-modal
  {"id":"learning-lesson-delete-confirm","title":"删除课节确认","channel":"学习中心","type":"confirm","category":"confirmation","status":"ready","source":"window.__GAIP_LEARNING_APP__.openConfirm(\"lesson-delete\", \"示例课节\")","invoke":{"path":"__GAIP_LEARNING_APP__.openConfirm","args":["lesson-delete","示例课节"]},"styles":["shared/styles/global-font.css?v=20260909-project-font-1","shared/styles/global-modal.css?v=20260909-project-font-1","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"after":"learning-last-lesson-offline-confirm"}
  */
  /* @gaip-modal
  {"id":"learning-study-log","title":"学情管理操作日志","channel":"学习中心","type":"modal","category":"information","status":"ready","source":"window.__GAIP_LEARNING_APP__.openStudyLog()","invoke":{"path":"__GAIP_LEARNING_APP__.openStudyLog","args":[]},"styles":["shared/styles/global-modal.css","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1","shared/styles/global-filter-bar.css?v=20260910-tree-combobox-1","shared/styles/global-table.css","features/learning-center/learning-v11.css?v=20260910-study-detail-modal-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/global-filter-bar.js?v=20260910-tree-combobox-1","shared/scripts/global-table.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"after":"learning-lesson-delete-confirm"}
  */
  /* @gaip-modal
  {"id":"learning-study-detail","title":"学员学习详情","channel":"学习中心","type":"modal","category":"information","status":"ready","styles":["shared/styles/global-font.css","shared/styles/global-modal.css","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1","shared/styles/global-multi-select.css","shared/styles/organization-tree.css","shared/styles/global-filter-bar.css?v=20260910-tree-combobox-1","shared/styles/global-table.css","features/learning-center/learning-v11.css?v=20260910-study-detail-modal-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/global-multi-select.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","shared/scripts/global-filter-bar.js?v=20260910-tree-combobox-1","shared/scripts/global-table.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"source":"window.__GAIP_LEARNING_APP__.openStudyDetail(\"users\")","invoke":{"path":"__GAIP_LEARNING_APP__.openStudyDetail","args":["users"]}}
  */
  /* @gaip-modal
  {"id":"learning-course-study-detail","title":"课程学习详情","channel":"学习中心","type":"modal","category":"information","status":"ready","styles":["shared/styles/global-font.css","shared/styles/global-modal.css","shared/styles/global-modal-position.css","shared/styles/global-modal-mask.css?v=20260910-backdrop-1","shared/styles/global-multi-select.css","shared/styles/organization-tree.css","shared/styles/global-filter-bar.css?v=20260910-tree-combobox-1","shared/styles/global-table.css","features/learning-center/learning-v11.css?v=20260910-study-detail-modal-1"],"scripts":["shared/scripts/global-modal.js","shared/scripts/global-modal-position.js","shared/scripts/global-multi-select.js","shared/scripts/organization-store.js","shared/scripts/organization-tree.js","shared/scripts/global-filter-bar.js?v=20260910-tree-combobox-1","shared/scripts/global-table.js","features/learning-center/learning-data.js","features/learning-center/learning-app.js?v=20260910-study-detail-modal-1"],"source":"window.__GAIP_LEARNING_APP__.openStudyDetail(\"courses\")","invoke":{"path":"__GAIP_LEARNING_APP__.openStudyDetail","args":["courses"]}}
  */
})();
