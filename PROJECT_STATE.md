...
- 分支：`main`
- 最近已发布功能提交：`716aa78`（配置中心、共享主导航、弹窗预览、财富值概览及跨频道共享修正；见 [[knowledge/变更/2026-09-02-配置中心与共享导航更新]]）
...
- 财富值中心“我的财富值”背景已在本地再次替换为 `wealth-overview-user-wide.jpg`，同系列 `20260901`、`20260902` 旧文件已按用户要求删除；图片 URL、财富值 CSS 和频道注册表缓存均为 `20260902-2`，尚未发布。
