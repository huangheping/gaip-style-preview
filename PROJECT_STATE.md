...
- 配置中心新增独立“公告管理”二级页，已完成内容区顶部分割线、列表、自动状态、分页、空状态、100 字三语标题边界 Mock、三语完整 Tooltip、标题语言兜底、自适应标题输入、新建/编辑和删除确认；弹窗 body/footer 结构与紧凑按钮已校正，分页方向图标已恢复。按文字需求，“展示中”的公告禁止删除。三类公告弹窗已同步进入全局弹窗预览。详见 [[knowledge/变更/当前未发布变更#配置中心公告管理独立子页面|当前未发布变更]]。
- 配置中心独立“操作日志”频道已完善搜索、整块日期选择、查看类记录文案、变更内容正文色和表头单行展示；与组织架构右上角独立日志弹窗继续隔离。详见 [[knowledge/变更/当前未发布变更#配置中心二级操作日志筛选与表格细节|当前未发布变更]]。
- 组织架构成员列表已移除分页，当前节点或搜索结果的全部成员一次展示；表格在右侧剩余高度内独立双向滚动，表头吸顶且横向滚动条停留在可视区域底部。详见 [[knowledge/变更/当前未发布变更#组织架构成员列表取消分页|当前未发布变更]]。
