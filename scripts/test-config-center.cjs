...
async function main() {
  ...
  assert.equal(one('[data-bulk-back]').nextElementSibling, one('[data-bulk-download-fail]'), 'previous step comes before failure download');
  assert.equal(one('[data-bulk-download-fail]').nextElementSibling, one('[data-bulk-confirm]'), 'failure download comes before the primary confirm action');
