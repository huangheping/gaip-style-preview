(function () {
  ...
  var entries = [
    {
      id: 'ai-notice', title: 'AI 内容重要提示', channel: '共享组件', type: 'modal', category: 'information', status: 'ready', height: 720,
    ...
    {
      id: 'poster-share', title: '文章海报分享', channel: '资讯中心 / 共享组件', type: 'modal', category: 'information', status: 'ready', height: 900,
    ...
    {
      id: 'operation-log', title: '操作日志', channel: '配置中心 / 共享组件', type: 'modal', category: 'information', status: 'ready', height: 900,
    ...
    {
      id: 'news-article', title: '资讯文章详情', channel: '资讯中心', type: 'modal', category: 'information', status: 'ready', height: 900,
    ...
    {
      id: 'config-member', title: '配置中心成员编辑', channel: '配置中心', type: 'modal', category: 'form', status: 'ready', height: 900,
    ...
    {
      id: 'config-department', title: '部门名称编辑', channel: '配置中心', type: 'modal', category: 'form', status: 'ready', height: 620,
    ...
    {
      id: 'config-delete', title: '删除部门确认', channel: '配置中心', type: 'confirm', category: 'confirmation', status: 'ready', height: 520,
    ...
    {
      id: 'config-admin', title: '设置管理员', channel: '配置中心', type: 'modal', category: 'form', status: 'ready', height: 900,
    ...
    { id: 'agent-session-rename', title: '编辑对话名称', channel: '全局操作 / AI Agent', type: 'modal', category: 'form', status: 'ready', height: 820, previewMode: 'route-trigger', route: '/workspace', source: '登录.html#/workspace → AI Agent 入口 → 更多操作 → 修改名称' },
    ...
    { id: 'clues-assign', title: '分配线索', channel: '线索中心 · 列表', type: 'modal', category: 'form', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/clues', source: '登录.html#/clues → 首条线索 → 分配' },
    { id: 'clues-terminal', title: '标记转化 / 标记关闭', channel: '线索中心 · 列表', type: 'modal', category: 'form', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/clues', source: '登录.html#/clues → 首条线索 → 转化' },
    { id: 'clues-detail', title: '线索详情', channel: '线索中心 · 详情', type: 'modal', category: 'information', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/clues', source: '登录.html#/clues → 详情' },
    { id: 'clues-create', title: '新增线索', channel: '线索中心 · 列表', type: 'modal', category: 'form', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/clues', source: '登录.html#/clues → 新增线索' },
    ...
    { id: 'customer-intro', title: '编辑客户资料介绍', channel: '客户中心360 · 客户画像', type: 'modal', category: 'form', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/customer', source: '登录.html#/customer → 客户资料介绍 → 编辑' },
    { id: 'customer-meeting', title: '新增 / 编辑沟通纪要', channel: '客户中心360 · 沟通纪要', type: 'modal', category: 'form', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/customer', source: '登录.html#/customer → 沟通纪要 → 新增沟通纪要' },
    { id: 'customer-meeting-delete', title: '删除沟通纪要确认', channel: '客户中心360 · 沟通纪要', type: 'confirm', category: 'confirmation', status: 'ready', height: 820, previewMode: 'route-trigger', route: '/customer', source: '登录.html#/customer → 沟通纪要 → 删除' },
    { id: 'customer-delete', title: '删除客户确认', channel: '客户中心360 · 客户详情', type: 'confirm', category: 'confirmation', status: 'ready', height: 820, previewMode: 'route-trigger', route: '/customer', source: '登录.html#/customer → 删除客户' },
    { id: 'customer-proposal-detail', title: '历史方案详情', channel: '客户中心360 · 历史方案', type: 'modal', category: 'information', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/customer', source: '登录.html#/customer → 历史方案 → 查看详情' },
    { id: 'activity-record', title: '报名记录', channel: '活动中心 · 我的报名', type: 'modal', category: 'information', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/activity', source: '登录.html#/activity → 我的报名 → 报名记录' },
    ...
    { id: 'product-detail', title: '产品详情', channel: '产品中心 · 产品列表', type: 'modal', category: 'information', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/product', source: '登录.html#/product → 产品卡片' },
    { id: 'product-expert', title: '业务线对接专家', channel: '产品中心 · 产品列表', type: 'modal', category: 'information', status: 'ready', height: 900, previewMode: 'route-trigger', route: '/product', source: '登录.html#/product → 联系产品专家' },
