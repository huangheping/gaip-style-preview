(function () {
  ...
  var configStyles = [umi, font, 'features/config-center/ant-source.css?v=20260831-1', 'features/config-center/config-center-content.css?v=20260903-32', 'features/config-center/config-center.css?v=20260902-8'];
  var configScripts = ['shared/config/channels.js?v=20260903-60', 'features/config-center/source-markup.js?v=20260902-1', 'features/config-center/config-center.js?v=20260903-41'];
